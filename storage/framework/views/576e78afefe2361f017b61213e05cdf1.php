					...
					<form action="<?php echo e(route('admin.authenticate')); ?>" method="post">
						<?php echo csrf_field(); ?>
				  		<div class="input-group mb-3">
							<input type="email" name="email" id="email" vlaue="<?php echo e(old('email')); ?>" class="form-control <?php $__errorArgs = ['email'];
...
</html><?php /**PATH C:\laragon\www\onlineshop\resources\views/admin/login.blade.php ENDPATH**/ ?>